...
func (s *Server) handleNotes(w http.ResponseWriter, r *http.Request) {
        ...
        switch r.Method {
        case http.MethodGet:
                s.GetNotes(w, r, userId)
        case http.MethodPost:
                s.PostNote(w, r, userId)
        default:
...
func (s *Server) GetNotes(w http.ResponseWriter, r *http.Request, userId int) {
        notes := s.db.GetNotes(userId)
        json.NewEncoder(w)
}

func (s *Server) PostNote(w http.ResponseWriter, r *http.Request, userId int) {
